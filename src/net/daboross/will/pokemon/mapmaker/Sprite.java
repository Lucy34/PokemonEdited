...
/**
 * all types of sprites extend this interface. This is necessary to be able to
 * render them easily.
 *
 * All sprites also have a logic() method. this is used by AI to update
 * positions, or simply might check a value on the controller or keyboard and
 * move the character...
 */
